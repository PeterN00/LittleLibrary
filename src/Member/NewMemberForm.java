 ...
 * @author Admin
 */
public final class NewMemberForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/NewMember.png"))); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                            .addComponent(jLabel1)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(tfIDCardNum, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(18, 18, 18)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btAddMemberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAddMemberActionPerformed
        ...
        if(tfIDCardNum.getText().length()!=12){
            JOptionPane.showMessageDialog(null, "ID Card Number contains 12 numbers!", "Alert!", JOptionPane.INFORMATION_MESSAGE);
            tfIDCardNum.setBackground(Color.yellow);
            return;
        }
        ...
        MemberManagement.addMember(tfIDCardNum.getText(), tfFirstName.getText().trim(), tfLastName.getText().trim(), gender, DOB, tfPhone.getText(), tfEmail.getText().trim()
